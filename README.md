...
> Fork note: this `alexlitech7` fork adds a repo-local confirmation policy for
> safer Codex CLI testing. Read-only actions are allowed automatically, while
> write/delete/dangerous actions require confirmation by default. See
> [docs/codex-cli-smoke-test.md](docs/codex-cli-smoke-test.md).
